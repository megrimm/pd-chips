...
FrameBuffer::FrameBuffer()
   :  myConsole(0),
      ...
      myInfoMenuWidth(0)
{
	jitPix = new unsigned short[210 * 160];
}
...
int FrameBuffer::setImage(const unsigned char* img) {
	return 0;
}

void FrameBuffer::doSomething(uInt16 newPC) 
{
}

void FrameBuffer::doRAM(bool read, uInt16 index ,uInt16 val) 
{
}

void FrameBuffer::doTia(bool peek, uInt16 addr, uInt16 value) 
{
}
...
void FrameBuffer::update(int rowStride, int dim0, int dim1, char* bp)
{
  // Do any pre-frame 
  ...
  if(!myMenuMode)
  {
    ...
    drawMediaSource(rowStride, dim0, dim1, bp);
