...
extern void apu_create(t_nes_square *x, int cpunum, double basefreq, int sample_rate, int refresh_rate, int sample_bits);
extern void apu_setparams(t_nes_square *x, int sample_rate, int refresh_rate, int sample_bits);

extern void apu_process(t_nes_square *x, t_float *buffer, int num_samples);
extern void apu_reset(t_nes_square *x);

extern void apu_setfilter(t_nes_square *x, int filter_type);
extern void apu_setchan(int chan, boolean enabled);

extern uint8 apu_read(t_nes_square *x, uint32 address);
extern void apu_write(t_nes_square *x, uint32 address, uint8 value);
